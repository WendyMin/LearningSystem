...
export default ( state = {
  ...
  switch( type ){
    ...
    /*  defineAsyncActionReducer __LOAD_DID_TEST start  */
    case __LOAD_DID_TEST.pending: {
    ...
    case __LOAD_DID_TEST.resolved: {
      ...
      return {
        ...state,
        loadState,
        didtest: response.didTest,
      };
    }
    case __LOAD_DID_TEST.rejected: {
