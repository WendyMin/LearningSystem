...
def offer_logic_ceshi(user):
    ...
    '''
    print(len(result_yi))
    print(len(result_zhong))
    print(len(result_nan))

    jsondata1 = json.dumps(result_yi, ensure_ascii=False)
    print jsondata1
    jsondata2 = json.dumps(result_zhong, ensure_ascii=False)
    print jsondata2
    jsondata3 = json.dumps(result_nan, ensure_ascii=False)
    print jsondata3
    '''
